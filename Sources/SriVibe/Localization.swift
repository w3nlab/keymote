...
enum L10n {
    static func text(_ key: String, _ language: AppLanguage) -> String {
        let english: [String: String] = [
            ...
            "application": "Application", "showInDock": "Show SriVibe in the Dock", "language": "Language", "appearance": "Appearance",
            ...
            "inputGranted": "Input Monitoring granted", "inputRequired": "Input Monitoring required", "inputDescription": "Allows SriVibe to receive paired Siri Remote HID button events.",
            "accessibilityGranted": "Accessibility granted", "accessibilityRequired": "Accessibility required", "accessibilityDescription": "Allows SriVibe to send configured keyboard actions to the frontmost application.",
            ...
            "v1Scope": "No voice, touchpad, system volume, mute, or power inputs are captured in V1.", "tap": "Tap", "holdAction": "Hold",
            ...
            "openSettings": "Open Settings…", "quit": "Quit SriVibe", "waiting": "Waiting for a paired Siri Remote", "diagnosticMode": "Diagnostic input mode — no actions are injected", "connected": "Connected: %@", "accessibilityNeeded": "Accessibility permission is required to perform actions", "diagnosticsCopied": "Diagnostics copied to clipboard"
        ]
        let chinese: [String: String] = [
            ...
            "application": "应用", "showInDock": "在 Dock 中显示 SriVibe", "language": "语言", "appearance": "外观",
            "hold": "长按", "longPress": "长按：%lld 毫秒", "status": "状态",
            "editing": "正在编辑：%@", "automaticMappings": "会根据前台应用自动选择按键映射。", "currentlyActive": "当前生效：%@",
            "inputGranted": "已授予输入监控权限", "inputRequired": "需要输入监控权限", "inputDescription": "允许 SriVibe 接收已配对 Siri Remote 的 HID 按键事件。",
            "accessibilityGranted": "已授予辅助功能权限", "accessibilityRequired": "需要辅助功能权限", "accessibilityDescription": "允许 SriVibe 向前台应用发送已配置的按键操作。",
            ...
            "v1Scope": "V1 不采集语音、触控板、系统音量、静音或电源按键。", "tap": "轻按", "holdAction": "长按",
            ...
            "openSettings": "打开设置…", "quit": "退出 SriVibe", "waiting": "正在等待已配对的 Siri Remote", "diagnosticMode": "诊断输入模式 — 不会发送任何操作", "connected": "已连接：%@", "accessibilityNeeded": "执行操作需要辅助功能权限", "diagnosticsCopied": "诊断信息已复制到剪贴板"
        ]
