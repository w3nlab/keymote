...
enum L10n {
    static func text(_ key: String, _ language: AppLanguage) -> String {
        let english: [String: String] = [
            ...
            "hold": "Hold", "longPress": "Long press: %lld ms", "doubleTapInterval": "Double-tap interval: %lld ms", "doubleTap": "Double tap", "status": "Status",
            ...
            "default": "Default", "playPause": "Play / Pause", "noAction": "No action", "up": "Up arrow", "down": "Down arrow", "left": "Left arrow", "right": "Right arrow", "return": "Return", "escape": "Escape", "delete": "Delete",
        ...
        let chinese: [String: String] = [
            ...
            "hold": "长按", "longPress": "长按：%lld 毫秒", "doubleTapInterval": "双击间隔：%lld 毫秒", "doubleTap": "双击", "status": "状态",
            ...
            "default": "默认", "playPause": "播放 / 暂停", "noAction": "无操作", "up": "上方向键", "down": "下方向键", "left": "左方向键", "right": "右方向键", "return": "回车", "escape": "退出", "delete": "删除",
